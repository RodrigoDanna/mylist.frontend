    ...
    <div className={`task-filter-panel ${isOpen ? 'open' : ''}`}>
      ...
      <section className="filter-section">
        ...
        <div className="filter-options">
          <label>
            <input type="checkbox" /> <span>Prioridade Alta</span>
          </label>
          <label>
            <input type="checkbox" /> <span>Prioridade Média</span>
          </label>
          <label>
            <input type="checkbox" /> <span>Prioridade Baixa</span>
          </label>
          <label>
            <input type="checkbox" /> <span>Com Prazo</span>
          </label>
          <label>
            <input type="checkbox" /> <span>Sem Prazo</span>
          </label>
          <label>
            <input type="checkbox" /> <span>Concluídas</span>
          </label>
          <label>
            <input type="checkbox" /> <span>Pendentes</span>
          </label>
        </div>
      </section>
